...
public class Robot extends TimedRobot {
	...
	public void teleopPeriodic() {		
		/* Gamepad processing */
		double forward = -max_speed * _gamepad.getY();
		...
		double motorCurrent = _rightMaster.getStatorCurrent();

		SmartDashboard.putNumber("Grabber Motor Output", forward);
		...
		//System.out.printf("Percent Output: %.4f  R vel: %f\n", _rightMaster.getMotorOutputPercent(),
		//	             _rightMaster.getSelectedSensorVelocity());
